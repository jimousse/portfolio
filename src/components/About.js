  ...
  return (
    <div className="about">
      ...
      <div className="about__text">
        ...
        <p className="about__description">I am a frontend developer based in <span className="location NL">
      Utrecht, Netherlands
    </span>.
         Currently working on the <Link href={SERVICENOW_LINK} label={LINK_LABEL} includeArrow />
