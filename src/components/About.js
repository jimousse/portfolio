  ...
  return (
    <div className="about">
      ...
      <div className="about__text">
        ...
        <p className="about__description">I am a frontend developer working on <Link href={SERVICENOW_LINK} label={LINK_LABEL} />
        the at ServiceNow. My main focus is on building a highly scalable data visualization library used through the whole product.
        </p>
      </div>
    </div>
  );
